...
NEWS_REGIONS = {
    ...
    "海南": ((110.35, 20.02), ("海南", "海口", "三亚")),
    "天津": ((117.20, 39.13), ("天津",)),
    "河北": ((114.51, 38.04), ("河北", "石家庄", "唐山", "保定", "雄安")),
    "山西": ((112.55, 37.87), ("山西", "太原")),
    "内蒙古": ((111.75, 40.84), ("内蒙古", "呼和浩特", "包头")),
    "辽宁": ((123.43, 41.80), ("辽宁", "沈阳", "大连")),
    "吉林": ((125.32, 43.90), ("吉林", "长春")),
    "黑龙江": ((126.64, 45.76), ("黑龙江", "哈尔滨")),
    "安徽": ((117.28, 31.86), ("安徽", "合肥")),
    "江西": ((115.89, 28.68), ("江西", "南昌")),
    "广西": ((108.32, 22.82), ("广西", "南宁", "桂林")),
    "贵州": ((106.71, 26.60), ("贵州", "贵阳")),
    "西藏": ((91.11, 29.65), ("西藏", "拉萨", "日喀则", "林芝")),
    "甘肃": ((103.83, 36.06), ("甘肃", "兰州")),
    "青海": ((101.78, 36.62), ("青海", "西宁")),
    "宁夏": ((106.23, 38.49), ("宁夏", "银川")),
    "香港": ((114.17, 22.32), ("香港",)),
    "澳门": ((113.55, 22.20), ("澳门",)),
    "台湾": ((121.51, 25.04), ("台湾", "台北", "高雄")),
}
